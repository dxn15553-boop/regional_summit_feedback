  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 justify-around md:flex-col md:justify-start md:p-4 md:pt-5 gap-1">
        <Link
          to="/"
          className="flex items-center justify-center gap-2 md:gap-3 px-2 py-2.5 md:px-4 md:py-3.5 md:rounded-xl transition-all duration-200 group"
          style={{
        ...
        >
          ...
          <div className="md:block">
            <p className="text-[11px] md:text-sm font-semibold">Submit Feedback</p>
        ...
        >
          ...
          <div className="md:block">
            <p className="text-[11px] md:text-sm font-semibold">Dashboard</p>
